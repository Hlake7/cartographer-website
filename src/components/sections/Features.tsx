import { Layers, User, RefreshCw, Map, Globe, Building } from "lucide-react";
    ...
    <section id="features" className="bg-white py-20 md:py-28">
      <div className="mx-auto max-w-7xl px-6">
        ...
        <p className="mt-8 text-center text-sm text-gray-400">
          *Ownership and property data availability varies by county and depends on the information supplied by each county.
        </p>
      </div>
    </section>
  );
